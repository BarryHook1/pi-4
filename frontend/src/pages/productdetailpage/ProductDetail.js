...
import { AuthContext } from "../../hooks/AuthContext"; // Importar o AuthContext
...
const ProductDetail = () => {
  ...
  const registerPurchase = async (paymentMethod) => {
    try {
      ...
      alert(
        "Erro ao registrar compra. Verifique o console para mais detalhes."
      );
    }
  };
      ...
      <div className="product-info">
        ...
        {seller && (
          <div className="seller-ratings">
            <h3>
              Avaliação do Vendedor: {seller.averageRating.toFixed(1)} / 5
            </h3>
            <div className="ratings-list">
              ...
              {seller.ratings.length > 3 && (
                <p>Veja mais avaliações na página do vendedor.</p>
              )}
            </div>
          </div>
        )}
